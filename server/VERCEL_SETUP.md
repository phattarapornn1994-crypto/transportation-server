...
เพิ่มตัวแปรต่อไปนี้ (จะถูกสร้างอัตโนมัติเมื่อสร้าง Postgres):

- `POSTGRES_URL` - Connection string สำหรับ Postgres
- `POSTGRES_PRISMA_URL` - Prisma connection string (ถ้ามี)

**หมายเหตุ**: Vercel จะสร้าง environment variables อัตโนมัติเมื่อสร้าง Postgres database
